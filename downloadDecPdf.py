    ...
    for page_num in range(0,page_size):
        ...
        for i in range(len(list_row)):
            ...
            if list_row[i]["entryId"]!=None:
                ...
                with open(list_row[i]["entryId"]+".pdf","wb") as f:
